    ...
    return (
        <>
            ...
            <span className='payment__payzen'>
                <p>Vous avez choisi le paiement en ligne par carte bancaire. Vous allez être redirigé sur le site sécurisé de Payzen, prestataire de paiement de Furet.com.</p>
